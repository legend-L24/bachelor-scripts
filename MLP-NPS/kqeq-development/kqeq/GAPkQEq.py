...
class GAPkQEq():
    ...
    def train(self, lambda_reg = 0.1, lambda_charges = 0.001, iter_charges = 3, 
...
class GAPkQEq_diff():
    ...
    def __init__(self, Kernel=None, scale_atsize=1.0, calculate_kernel_forces=True, 
                include_LJ=False, radius_type='qeq', sparse=False, sparse_count=None, 
                sparse_method="CUR",hard_lib=None, elements=None):
    ...
    def save_model(self,name="kqeq", gap_version=1631710424, atom_energy=[]):
        ...
        with open(f"{name}.xml","w") as xml:
            ...
            xml.write(f'    <gpCoordinates label="{name}1" dimensions="{sparse_dim}" signal_variance=".10000000000000001E+000" signal_mean=".00000000000000000E+000" sparsified="T" n_permutations="1" covariance_type="2" zeta="2.0000000000000000" n_sparseX="{sparse_len}" sparseX_filename="{name}.xml.sparseX.kqeq" sparseX_md5sum="2519cb796dd238f6aaf967cdf0dbb96e">\n')
